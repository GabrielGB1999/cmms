const locale = {
  ...
  no_discrepancy: "No discrepancy recorded",
  add_discrepancy: "Add discrepancy",
  edit_discrepancy: "Edit discrepancy",
  add_discrepancy_description: "Record something found during the procedure",
  discrepancy_description: "What was found",
  discrepancy_description_placeholder: "Describe the discrepancy",
  required_discrepancy_description: "A description is required",
  corrective_measure: "Corrective measure",
  corrective_measure_placeholder: "What was done about it, if anything",
  discrepancy_status_OPEN: "Open",
  discrepancy_status_CORRECTED: "Corrected",
  discrepancy_status_DEFERRED: "Deferred",
  derive_work_order: "Open a work order for this",
  derive_work_order_description: "A new work order, linked back to the one this discrepancy was found on",
  derived_work_order: "Derived work order",
  derived_work_order_success: "Work order created and linked",
  derived_from_discrepancy: "Raised from a discrepancy found on {{workOrder}}:\n\n{{description}}",
  risk_assessment: "Risk Assessment",
  ra_description: "Safety risk management: report hazards, how they are controlled and the action still needed.",
  ra_new_report: "New report",
  ra_edit_report: "Edit report",
  ra_new_report_description: "Answer the questions below to report a hazard",
  ra_report: "Report",
  ra_hazard: "What are the hazards?",
  ra_hazard_placeholder: "Describe the hazard",
  ra_who_might_be_harmed: "Who or what might be harmed?",
  ra_who_might_be_harmed_placeholder: "People, aircraft, equipment... and how",
  ra_current_controls: "What are you already doing to mitigate it?",
  ra_current_controls_placeholder: "Controls already in place",
  ra_further_action: "What further action do you think is needed to control the risks?",
  ra_further_action_placeholder: "Further action needed",
  ra_action_owner: "Who should carry out this action?",
  ra_action_due_date: "When is this action needed by?",
  ra_done: "Done",
  ra_required_hazard: "The hazard is required",
  ra_no_reports: "No risk reported yet",
  ra_create_success: "Risk reported",
  ra_save_failure: "The risk assessment could not be saved",
  ra_delete_success: "Report deleted",
  ra_confirm_delete: "Are you sure you want to delete this report?",
  ra_to_work_order: "Turn this report into a work order",
  risk_assessment_to_wo_description: "A work order for the corrective action, linked back to the risk assessment",
  risk_assessment_wo_success: "Work order created and linked to the report",
  corrective_action_title: "Corrective action - {{hazard}}",
  sign_here: 'Sign here',
