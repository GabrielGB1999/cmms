const ruJSON = {
  ...
  no_discrepancy: "Несоответствий не зафиксировано",
  add_discrepancy: "Добавить несоответствие",
  edit_discrepancy: "Изменить несоответствие",
  add_discrepancy_description: "Зафиксируйте обнаруженное в ходе работ",
  discrepancy_description: "Что обнаружено",
  discrepancy_description_placeholder: "Опишите несоответствие",
  required_discrepancy_description: "Описание обязательно",
  corrective_measure: "Корректирующее действие",
  corrective_measure_placeholder: "Что было предпринято, если применимо",
  discrepancy_status_OPEN: "Открыто",
  discrepancy_status_CORRECTED: "Устранено",
  discrepancy_status_DEFERRED: "Отложено",
  derive_work_order: "Создать наряд по этому несоответствию",
  derive_work_order_description: "Новый наряд, связанный с тем, где обнаружено несоответствие",
  derived_work_order: "Производный наряд",
  derived_work_order_success: "Наряд создан и связан",
  derived_from_discrepancy: "Создан по несоответствию, обнаруженному в {{workOrder}}:\n\n{{description}}",
