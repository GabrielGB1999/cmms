const deJSON = {
  ...
  no_discrepancy: "Keine Abweichung erfasst",
  add_discrepancy: "Abweichung hinzufügen",
  edit_discrepancy: "Abweichung bearbeiten",
  add_discrepancy_description: "Erfassen Sie einen Befund aus dem Arbeitsablauf",
  discrepancy_description: "Befund",
  discrepancy_description_placeholder: "Beschreiben Sie die Abweichung",
  required_discrepancy_description: "Eine Beschreibung ist erforderlich",
  corrective_measure: "Korrekturmaßnahme",
  corrective_measure_placeholder: "Was wurde dagegen unternommen, falls zutreffend",
  discrepancy_status_OPEN: "Offen",
  discrepancy_status_CORRECTED: "Behoben",
  discrepancy_status_DEFERRED: "Zurückgestellt",
  derive_work_order: "Arbeitsauftrag dafür anlegen",
  derive_work_order_description: "Ein neuer Arbeitsauftrag, verknüpft mit dem, in dem die Abweichung gefunden wurde",
  derived_work_order: "Abgeleiteter Arbeitsauftrag",
  derived_work_order_success: "Arbeitsauftrag erstellt und verknüpft",
  derived_from_discrepancy: "Angelegt aus einer Abweichung in {{workOrder}}:\n\n{{description}}",
