const locale = {
  ...
  no_discrepancy: "Nessuna discrepanza registrata",
  add_discrepancy: "Aggiungi discrepanza",
  edit_discrepancy: "Modifica discrepanza",
  add_discrepancy_description: "Registra un rilievo emerso durante la procedura",
  discrepancy_description: "Cosa è stato rilevato",
  discrepancy_description_placeholder: "Descrivi la discrepanza",
  required_discrepancy_description: "La descrizione è obbligatoria",
  corrective_measure: "Azione correttiva",
  corrective_measure_placeholder: "Cosa è stato fatto, se applicabile",
  discrepancy_status_OPEN: "Aperta",
  discrepancy_status_CORRECTED: "Corretta",
  discrepancy_status_DEFERRED: "Differita",
  derive_work_order: "Apri un ordine di lavoro per questo",
  derive_work_order_description: "Un nuovo ordine di lavoro, collegato a quello in cui è stata rilevata la discrepanza",
  derived_work_order: "Ordine di lavoro derivato",
  derived_work_order_success: "Ordine di lavoro creato e collegato",
  derived_from_discrepancy: "Creato da una discrepanza rilevata su {{workOrder}}:\n\n{{description}}",
  sign_here: 'Firma qui',
