const ptBRJSON = {
  ...
  no_discrepancy: "Nenhuma discrepância registrada",
  add_discrepancy: "Adicionar discrepância",
  edit_discrepancy: "Editar discrepância",
  add_discrepancy_description: "Registre algo encontrado durante o procedimento",
  discrepancy_description: "O que foi encontrado",
  discrepancy_description_placeholder: "Descreva a discrepância",
  required_discrepancy_description: "A descrição é obrigatória",
  corrective_measure: "Medida corretiva",
  corrective_measure_placeholder: "O que foi feito a respeito, se aplicável",
  discrepancy_status_OPEN: "Aberta",
  discrepancy_status_CORRECTED: "Corrigida",
  discrepancy_status_DEFERRED: "Adiada",
  derive_work_order: "Abrir uma ordem de serviço para isto",
  derive_work_order_description: "Uma nova ordem de serviço, vinculada àquela onde a discrepância foi encontrada",
  derived_work_order: "Ordem de serviço derivada",
  derived_work_order_success: "Ordem de serviço criada e vinculada",
  derived_from_discrepancy: "Gerada a partir de uma discrepância encontrada em {{workOrder}}:\n\n{{description}}",
