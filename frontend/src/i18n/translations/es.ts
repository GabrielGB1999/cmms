const esJSON = {
  ...
  no_discrepancy: "Ninguna discrepancia registrada",
  add_discrepancy: "Añadir discrepancia",
  edit_discrepancy: "Editar discrepancia",
  add_discrepancy_description: "Registre algo encontrado durante el procedimiento",
  discrepancy_description: "Qué se encontró",
  discrepancy_description_placeholder: "Describa la discrepancia",
  required_discrepancy_description: "Se requiere una descripción",
  corrective_measure: "Medida correctiva",
  corrective_measure_placeholder: "Qué se hizo al respecto, si procede",
  discrepancy_status_OPEN: "Abierta",
  discrepancy_status_CORRECTED: "Corregida",
  discrepancy_status_DEFERRED: "Diferida",
  derive_work_order: "Crear una orden de trabajo para esto",
  derive_work_order_description: "Una nueva orden de trabajo, vinculada a aquella donde se encontró la discrepancia",
  derived_work_order: "Orden de trabajo derivada",
  derived_work_order_success: "Orden de trabajo creada y vinculada",
  derived_from_discrepancy: "Generada a partir de una discrepancia encontrada en {{workOrder}}:\n\n{{description}}",
  risk_assessment: "Evaluación de riesgos",
  ra_description: "Gestión de riesgos de seguridad operacional: reportá peligros, cómo se controlan y qué acción falta.",
  ra_new_report: "Nuevo reporte",
  ra_edit_report: "Editar reporte",
  ra_new_report_description: "Respondé las preguntas para reportar un riesgo",
  ra_report: "Reportar",
  ra_hazard: "¿Cuáles son los riesgos?",
  ra_hazard_placeholder: "Describí el riesgo",
  ra_who_might_be_harmed: "¿Quién o qué podría resultar dañado?",
  ra_who_might_be_harmed_placeholder: "Personas, aeronaves, equipos... y cómo",
  ra_current_controls: "¿Qué has hecho vos hasta ahora para mitigarlo?",
  ra_current_controls_placeholder: "Controles ya implementados",
  ra_further_action: "¿Qué otras acciones considerás que deben realizarse para controlar los riesgos?",
  ra_further_action_placeholder: "Acciones adicionales necesarias",
  ra_action_owner: "¿Quién debería llevar adelante esta acción?",
  ra_action_due_date: "¿Para cuándo se necesita esta acción?",
  ra_done: "Realizado",
  ra_required_hazard: "El riesgo es obligatorio",
  ra_no_reports: "Todavía no se reportaron riesgos",
  ra_create_success: "Riesgo reportado",
  ra_save_failure: "No se pudo guardar la evaluación de riesgos",
  ra_delete_success: "Reporte eliminado",
  ra_confirm_delete: "¿Seguro que querés eliminar este reporte?",
  ra_to_work_order: "Convertir este reporte en orden de trabajo",
  risk_assessment_to_wo_description: "Una orden de trabajo para la acción correctiva, vinculada a la evaluación de riesgos",
  risk_assessment_wo_success: "Orden de trabajo creada y vinculada al reporte",
  corrective_action_title: "Acción correctiva - {{hazard}}",
