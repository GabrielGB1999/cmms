const trJSON = {
  ...
  no_discrepancy: "Kayıtlı uyumsuzluk yok",
  add_discrepancy: "Uyumsuzluk ekle",
  edit_discrepancy: "Uyumsuzluğu düzenle",
  add_discrepancy_description: "İşlem sırasında bulunan bir durumu kaydedin",
  discrepancy_description: "Ne bulundu",
  discrepancy_description_placeholder: "Uyumsuzluğu açıklayın",
  required_discrepancy_description: "Açıklama gerekli",
  corrective_measure: "Düzeltici önlem",
  corrective_measure_placeholder: "Bu konuda ne yapıldı, varsa",
  discrepancy_status_OPEN: "Açık",
  discrepancy_status_CORRECTED: "Düzeltildi",
  discrepancy_status_DEFERRED: "Ertelendi",
  derive_work_order: "Bunun için iş emri aç",
  derive_work_order_description: "Uyumsuzluğun bulunduğu iş emrine bağlı yeni bir iş emri",
  derived_work_order: "Türetilen iş emri",
  derived_work_order_success: "İş emri oluşturuldu ve bağlandı",
  derived_from_discrepancy: "{{workOrder}} üzerinde bulunan bir uyumsuzluktan oluşturuldu:\n\n{{description}}",
  sign_here: 'Buraya imzalayın',
  required_signature: 'İmza gerekli',
