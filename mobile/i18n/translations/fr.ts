const frJSON = {
  ...
  no_discrepancy: "Aucun écart enregistré",
  add_discrepancy: "Ajouter un écart",
  edit_discrepancy: "Modifier l'écart",
  add_discrepancy_description: "Enregistrez un constat fait pendant la procédure",
  discrepancy_description: "Constat",
  discrepancy_description_placeholder: "Décrivez l'écart",
  required_discrepancy_description: "Une description est requise",
  corrective_measure: "Mesure corrective",
  corrective_measure_placeholder: "Ce qui a été fait, le cas échéant",
  discrepancy_status_OPEN: "Ouvert",
  discrepancy_status_CORRECTED: "Corrigé",
  discrepancy_status_DEFERRED: "Reporté",
  derive_work_order: "Créer un bon de travail pour cet écart",
  derive_work_order_description: "Un nouveau bon de travail, lié à celui où l'écart a été constaté",
  derived_work_order: "Bon de travail dérivé",
  derived_work_order_success: "Bon de travail créé et lié",
  derived_from_discrepancy: "Créé à partir d'un écart constaté sur {{workOrder}} :\n\n{{description}}",
